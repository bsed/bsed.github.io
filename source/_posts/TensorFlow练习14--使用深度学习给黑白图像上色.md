---
title: "TensorFlow练习14: 使用深度学习给黑白图像上色"
categories: [ "大数据/NLP" ]
tags: [ "python","tensorflow","斗大的熊猫" ]
draft: false
slug: "tensorflow-exercise-14-use-indepth-learning-to-color-black-and-white-images"
date: "2019-09-20 16:32:00"
---

网上有很多使用PS给黑白老照片上色的教程，下图是P上颜色的爱因斯坦：

![屏幕快照-2016-12-07-上午11.01.28-230x300.png][1] ![屏幕快照-2016-12-07-上午11.01.44-236x300.png][2]
...
本帖就使用前文的[妹子图](http://blog.topspeedsnail.com/archives/10660)训练这个模型，看看效果。
...
![TensorFlow练习14: 使用深度学习给黑白图像上色](TensorFlow练习14%20使用深度学习给黑白图像上色%20–%20WTF%20Daily%20Blog_files/4000_0.png)左: 黑白图像;   中: 上色之后;   右: 原图
...
![old_pic.jpg][3]你知道她是谁吗？


> **本文是对斗大的熊猫tensorflow系列文章的备份。D啪乐嗯QQ: 193093683 **

  [1]: https://imgs.gnux.cn/usr/uploads/2019/09/3144171383.png
  [2]: https://imgs.gnux.cn/usr/uploads/2019/09/3591015497.png
  [3]: https://imgs.gnux.cn/usr/uploads/2019/09/2599340299.jpg