...
---
## 一、预加载图像
![58680-sapwylwj48h.png](https://imgs.gnux.cn/usr/uploads/2019/05/4232474529.png)
...
```javascript
$("img").load(function() {
  console.log("image load successfull");
});
```
