---
title: How To Ask Questions The Smart Way [ 转 ] 
date: 2018-10-18 10:01:00
updated: 2018-10-18 16:05:07
tags: 
- linux
- ubuntu
- debian
...
（欢迎对本指南提出改进意见。你可以 email 你的建议至 [esr@thyrsus.com](https://runtua.cn/archives/esr@thyrsus.com) 或 [respond-auto@linuxmafia.com](https://runtua.cn/archives/respond-auto@linuxmafia.com)。然而请注意，本文并非[网络礼节](http://www.ietf.org/rfc/rfc1855.txt)的通用指南，而我们通常会拒绝无助于在技术论坛得到有用答案的建议。）
...
更白话的说，如果你写得像是个半文盲[译注：[小白](http://zh.wikipedia.org/zh-tw/)]，那多半得不到理睬。也不要使用即时通讯中的简写或[火星文](http://zh.wikipedia.org/zh-tw/)，如将`的`简化为`ㄉ`会使你看起来像一个为了少打几个键而省字的小白。更糟的是，如果像个小孩似地鬼画符那绝对是在找死，可以肯定没人会理你（或者最多是给你一大堆指责与挖苦）。
...
请记得，还有许多其它使用者没遇到你发现的问题，否则你在阅读文件或搜索网页时就应该发现了（你在抱怨前[已经做了这些，是吧](https://runtua.cn/archives/how-to-ask-questions-the-smart-way.html#)？）。这也意味着很有可能是你弄错了而不是软件本身有问题。
...
最有效描述程序问题的方法是提供最精简的 Bug 展示测试用例（bug-demonstrating test case）。什么是最精简的测试用例？那是问题的缩影；一小个程序片段能**刚好**展示出程序的异常行为，而不包含其他令人分散注意力的内容。怎么制作最精简的测试用例？如果你知道哪一行或哪一段代码会造成异常的行为，复制下来并加入足够重现这个状况的代码（例如，足以让这段代码能被编译/直译/被应用程序处理）。如果你无法将问题缩减到一个特定区块，就复制一份代码并移除不影响产生问题行为的部分。总之，测试用例越小越好（查看[话不在多而在精](https://runtua.cn/archives/how-to-ask-questions-the-smart-way.html#)一节）。
...
问题：[我能在哪找到 X 程序或 X 资源？](https://runtua.cn/archives/how-to-ask-questions-the-smart-way.html#q1)

问题：[我怎样用 X 做 Y？](https://runtua.cn/archives/how-to-ask-questions-the-smart-way.html#q2)

问题：[如何设定我的 shell 提示？](https://runtua.cn/archives/how-to-ask-questions-the-smart-way.html#q3)

问题：[我可以用 Bass-o-matic 文件转换工具将 AcmeCorp 档案转换为 TeX 格式吗？](https://runtua.cn/archives/how-to-ask-questions-the-smart-way.html#q4)

问题：[我的程序/设定/SQL 语句没有用](https://runtua.cn/archives/how-to-ask-questions-the-smart-way.html#q5)

问题：[我的 Windows 电脑有问题，你能帮我吗？](https://runtua.cn/archives/how-to-ask-questions-the-smart-way.html#q6)

问题：[我的程序不会动了，我认为系统工具 X 有问题](https://runtua.cn/archives/how-to-ask-questions-the-smart-way.html#q7)

问题：[我在安装 Linux（或者 X ）时有问题，你能帮我吗？](https://runtua.cn/archives/how-to-ask-questions-the-smart-way.html#q8)

问题：[我怎么才能破解 root 帐号/窃取 OP 特权/读别人的邮件呢？](https://runtua.cn/archives/how-to-ask-questions-the-smart-way.html#q9)
...
回答：如果你有足够的智慧提这个问题，你也该有足够的智慧去 [RTFM](https://runtua.cn/archives/how-to-ask-questions-the-smart-way.html#RTFM)，然后自己去找出来。
...
这种问法无非想得到 [STFW](https://runtua.cn/archives/how-to-ask-questions-the-smart-way.html#RTFM) 这样的回答。
...
如果你需要个人电脑、Unix 系统和网络如何运作的基础知识，参阅 [Unix 系统和网络基本原理](http://en