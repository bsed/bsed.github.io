---
title: "在Visual Studio Code中使用CSSComb格式化CSS文件"
categories: [ "Css" ]
tags: [ "css","csscomb" ]
draft: false
slug: "formatting-css-files-with-csscomb-in-visual-studio-code"
date: "2018-11-19 14:23:00"
---

不管是在JS文件还是在HTML文件中，右键点击，都有“格式化文件”的菜单，帮助我们排版。可是在CSS文件中，却没有这样的选项，这时候我们就要通过插件帮我们完成这项工作了。先看下格式化后的效果图：
![88500-vgidwmndw4.png](https://imgs.gnux.cn/usr/uploads/2018/11/1291281519.png)
...
​	这时候我们就可以对CSS文件格式化了。
​	打开一个CSS格式文件，按“F1”，选择“CSSComb: Format styles”，格式化成功！
